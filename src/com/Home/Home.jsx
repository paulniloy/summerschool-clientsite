...
const Home = () => {
    ...
    return (
        <div className={color ? 'bg-white text-black' : 'bg-gray-800 text-white'}>
            ...
            <div>
                <Headings heading={"Status"} subheading={"statistic"}></Headings>
                <div className='flex justify-center flex-col md:w-1/2 md:mx-auto'>
                    <div className="stats shadow p-10 flex flex-col md:flex-row">
